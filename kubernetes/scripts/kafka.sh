...
kubectl -n $KAFKA_NAMESPACE apply -f "$FILEPATH/cluster_deploy.yml"
kubectl wait kafka/my-cluster-$namespace --for=condition=Ready --timeout=300s -n $KAFKA_NAMESPACE